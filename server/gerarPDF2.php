...
$gerandoPDF = $conexao_pdo->prepare("SELECT * FROM t_saidas_os,t_tecnicos WHERE t_saidas_os.id_tecnico = t_tecnicos.id AND id_numero_os = $id");
$gerandoPDF->execute();
$valor = array();
...
<col style="width: 236px">
  ...
  <tr>
    <td class="tg-b7b8"><b>Cabo Óptico (Metros)</td>
  ...
  <tr>
   ...
   <tr>
    <td class="tg-b7b8"><b>Cabo de Rede (Metros)</td>
   ...
   <!--testetete-->
    ...
    <tr>
    <td class="tg-b7b8"><b>Conectores SC APC</td>
    <td class="tg-b7b8"><b>'.$qnt_conectores.'</b></td>
    <td class="tg-b7b8">1 (   ) 2 (    ) 3 (    ) 4 (   ) 5 (   )</td>
   </tr>
    <tr>
    <td class="tg-b7b8"><b>Conectores SC PC</td>
    <td class="tg-b7b8"><b>'.$qnt_conectores2.'</b></td>
    <td class="tg-b7b8">1 (   ) 2 (    ) 3 (    ) 4 (   ) 5 (   )</td>
   </tr>
    <tr>
    <td class="tg-b7b8"><b>Conector RJ45</td>
    <td class="tg-b7b8"><b>'.$qnt_conectores_rj45.'</b></td>
    <td class="tg-b7b8">1 (   ) 2 (    ) 3 (    ) 4 (   ) 5 (   )</td>
   </tr>
      <tr>
    <td class="tg-b7b8"><b>Bap</td>
