$('#formTecnicoRecolhimento2').submit(function() {
	// Convertemos os dados do formulário para Objeto
	var dados = {};
	$('#formTecnicoRecolhimento2').serializeArray().map(function(x){dados[x.name] = x.value;});
...
$('#encaminhado_financeiro').change(function(){
	if( $(this).val() == 'true' ){
		$('#div_financeiro').show('block');
	}
	else {
		$('#div_financeiro').hide();
	}
