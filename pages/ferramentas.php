		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>Estoque<small>EPI / EPC</small></h1>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
						<li><a href="#">Estoque</a></li>
						<li class="active">Ferramentas EPI / EPC</li>
					</ol>
				</section>
				<!-- Main content -->
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group has-feedback" id="div_combo" style="display: none;">	
													...
													<input type="text"  class="form-control" placeholder="Serial SetupBox" id="serial_onu" name="serial_onu" ><br>
													<label>Cabo de Rede: </label><br>	
                      								<input type="number" name="stb_rj45" id="stb_rj45"  min="0" placeholder="Metros" class="flat-red"><br><br>
  													<input type="checkbox" name="stb_fonte" id="stb_fonte" value="true" class="flat-red">
                      								<label>Fonte</label>
